        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="container"> <p class="lead mb-5">¿EN CUAL MESA QUIERES GANAR?</p>
                    <div class="row">
                        <div class="col-md-4"><a  href="{{url('cronometro')}}"> <P>MESA LIBRES</P><img class="img-mesas" src="{{url('img/mesabandas.png')}}"with="100"></a></div>
                        <div class="col-md-4"><a  href="{{url('cronometro')}}"> <P>MESA 3 BANDAS</P><img class="img-mesas" src="{{url('img/mesabandas.png')}}"with="100"></a></div>
                        <div class="col-md-4"><a  href="{{url('cronometro')}}"><P>MESA POOL</P> <img class="img-mesas" src="{{url('img/mesapool.png')}}"with="100"></a></div>
                    </div>
                    <br></br>
