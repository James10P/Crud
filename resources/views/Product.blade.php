        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="row">
                        <div class="col-md-6"><a  href="{{url('buy')}}"> <img class="img-productos" src="{{url('img/Aguardiente.jpg')}}"> </a>
</div>
                    <div class="col-md-6" ><a  href="{{url('buy')}}"> <img class="img-productos" src="{{url('img/Paquetes.jpg')}}" > </a></div>
                    </div>
